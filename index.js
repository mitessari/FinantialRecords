...
for (let i = 0; i < finances.length; i++) {
   ...
   if (profitLoss> greatestIncrease.amount) {
    greatestIncrease.date = date;
    greatestIncrease.amount = profitLoss;
   } 

   if (profitLoss < greatestDecrease.amount) {
    greatestDecrease.date = date;
    greatestDecrease.amount = profitLoss;
  }
};

console.log ("Total:" + "$"+ netTotal);

let totalAverage = Math.round((avTotal/totalMonths) * 100) / 100;
console.log("Average Change: " + "$"+totalAverage);

console.log("Greatest increase in profits: " + greatestIncrease.date, 'Amount: ' + 
"$" + greatestIncrease.amount);

console.log("Greatest decrease in profits: " + greatestDecrease.date, 'Amount: ' + 
